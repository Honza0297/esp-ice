...
#
# Compile and run the C unit tests for the cconfig report subsystem.
...
$CC -std=c99 $SAN_FLAGS -I. -It -o "$O/test_report" \
    cconfig/t/test_report.c "$LIBICE" $LINK_LIBS || exit 1
cd "$O" && ./test_report
