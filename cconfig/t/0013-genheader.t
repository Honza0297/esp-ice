...
#
# Compile and run the C unit tests for the C header output.
...
$CC -std=c99 $SAN_FLAGS -I. -It -o "$O/test_genheader" \
    cconfig/t/test_genheader.c "$LIBICE" $LINK_LIBS || exit 1
cd "$O" && ./test_genheader fixtures/ok
