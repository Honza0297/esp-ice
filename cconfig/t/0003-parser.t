...
#
# Compile and run the C unit tests for the cconfig Kconfig parser.
...
$CC -std=c99 $SAN_FLAGS -I. -It -o "$O/test_parser" \
    cconfig/t/test_parser.c "$LIBICE" $LINK_LIBS || exit 1
cd "$O" && ./test_parser
