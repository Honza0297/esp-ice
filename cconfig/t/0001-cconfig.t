...
#
# Compile and run the C unit tests for the cconfig symbol table and expressions.
...
$CC -std=c99 $SAN_FLAGS -I. -It -o "$O/test_cconfig" \
    cconfig/t/test_cconfig.c "$LIBICE" $LINK_LIBS || exit 1
cd "$O" && ./test_cconfig
