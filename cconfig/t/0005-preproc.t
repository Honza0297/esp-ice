...
#
# Compile and run the C unit tests for the Kconfig macro/variable
# preprocessor.
...
$CC -std=c99 $SAN_FLAGS -I. -It -o "$O/test_preproc" \
    cconfig/t/test_preproc.c "$LIBICE" $LINK_LIBS || exit 1
cd "$O" && ./test_preproc
