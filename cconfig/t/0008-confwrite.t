...
#
# Compile and run the C unit tests for the sdkconfig writer.
...
$CC -std=c99 $SAN_FLAGS -I. -It -o "$O/test_confwrite" \
    cconfig/t/test_confwrite.c "$LIBICE" $LINK_LIBS || exit 1
cd "$O" && ./test_confwrite fixtures/ok
